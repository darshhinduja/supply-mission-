...
function setup() {
	...
	//create red zone
	boxbase = Bodies.rectangle(width/2, 640, 200, 20 , {isStatic:true} );
	 World.add(world, boxbase);
	 
	 boxl = Bodies.rectangle(width/2-100, 620, 20, 100 , {isStatic:true} );
	 World.add(world, boxl);
	 
	 boxr = Bodies.rectangle(width/2+100, 610, 20, 100 , {isStatic:true} );
